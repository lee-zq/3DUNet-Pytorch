...
parser.add_argument('--crop_slices', type=list, default=48,help='patch size of train samples after resize')
...
parser.add_argument('--early-stop', default=100, type=int, help='early stopping (default: 20)')
