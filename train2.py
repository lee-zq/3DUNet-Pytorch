...
if __name__ == '__main__':
    ...
    # data info
    train_set = Lits_DataSet([16, 96, 96], 0.5, args.dataset_path, mode='train')
    val_set = Lits_DataSet([16, 96, 96], 0.5, args.dataset_path, mode='val')
    train_loader = DataLoader(dataset=train_set,batch_size=2,num_workers=4, shuffle=True)
    val_loader = DataLoader(dataset=val_set,batch_size=2,num_workers=4, shuffle=True)
    # model info
